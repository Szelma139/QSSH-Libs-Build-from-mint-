#############################################################################
# Makefile for building: qssh
# Generated by qmake (3.1) (Qt 5.9.5)
# Project:  ../qssh.pro
# Template: subdirs
# Command: /usr/lib/qt5/bin/qmake -o Makefile ../qssh.pro
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = qssh1.0.0
DISTDIR = /home/radek/SSH/QSSh2/QSsh/build/.tmp/qssh1.0.0
SUBTARGETS    =  \
		sub-src \
		sub-examples \
		sub-tests
...
sub-src-qmake_all:  FORCE
	...
	cd src/ && $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/src/src.pro
	cd src/ && $(MAKE) -f Makefile qmake_all
sub-src: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/src/src.pro ) && $(MAKE) -f Makefile
...
sub-src-all-ordered: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/src/src.pro ) && $(MAKE) -f Makefile all
sub-src-all: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/src/src.pro ) && $(MAKE) -f Makefile all
sub-src-clean-ordered: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/src/src.pro ) && $(MAKE) -f Makefile clean
sub-src-clean: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/src/src.pro ) && $(MAKE) -f Makefile clean
sub-src-distclean-ordered: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/src/src.pro ) && $(MAKE) -f Makefile distclean
sub-src-distclean: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/src/src.pro ) && $(MAKE) -f Makefile distclean
sub-src-install_subtargets-ordered: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/src/src.pro ) && $(MAKE) -f Makefile install
sub-src-install_subtargets: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/src/src.pro ) && $(MAKE) -f Makefile install
sub-src-uninstall_subtargets-ordered: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/src/src.pro ) && $(MAKE) -f Makefile uninstall
sub-src-uninstall_subtargets: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/src/src.pro ) && $(MAKE) -f Makefile uninstall
sub-examples-qmake_all: sub-src-qmake_all FORCE
	@test -d examples/ || mkdir -p examples/
	cd examples/ && $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/examples/examples.pro
	cd examples/ && $(MAKE) -f Makefile qmake_all
sub-examples: FORCE
	@test -d examples/ || mkdir -p examples/
	cd examples/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/examples/examples.pro ) && $(MAKE) -f Makefile
...
sub-examples-all-ordered: sub-src-all-ordered  FORCE
	@test -d examples/ || mkdir -p examples/
	cd examples/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/examples/examples.pro ) && $(MAKE) -f Makefile all
sub-examples-all: FORCE
	@test -d examples/ || mkdir -p examples/
	cd examples/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/examples/examples.pro ) && $(MAKE) -f Makefile all
sub-examples-clean-ordered: sub-src-clean-ordered  FORCE
	@test -d examples/ || mkdir -p examples/
	cd examples/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/examples/examples.pro ) && $(MAKE) -f Makefile clean
sub-examples-clean: FORCE
	@test -d examples/ || mkdir -p examples/
	cd examples/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/examples/examples.pro ) && $(MAKE) -f Makefile clean
sub-examples-distclean-ordered: sub-src-distclean-ordered  FORCE
	@test -d examples/ || mkdir -p examples/
	cd examples/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/examples/examples.pro ) && $(MAKE) -f Makefile distclean
sub-examples-distclean: FORCE
	@test -d examples/ || mkdir -p examples/
	cd examples/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/examples/examples.pro ) && $(MAKE) -f Makefile distclean
sub-examples-install_subtargets-ordered: sub-src-install_subtargets-ordered  FORCE
	@test -d examples/ || mkdir -p examples/
	cd examples/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/examples/examples.pro ) && $(MAKE) -f Makefile install
...
sub-examples-uninstall_subtargets-ordered: sub-src-uninstall_subtargets-ordered  FORCE
	@test -d examples/ || mkdir -p examples/
	cd examples/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/examples/examples.pro ) && $(MAKE) -f Makefile uninstall
sub-examples-uninstall_subtargets: FORCE
	@test -d examples/ || mkdir -p examples/
	cd examples/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/examples/examples.pro ) && $(MAKE) -f Makefile uninstall
sub-tests-qmake_all: sub-examples-qmake_all FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/tests/tests.pro
	cd tests/ && $(MAKE) -f Makefile qmake_all
sub-tests: FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/tests/tests.pro ) && $(MAKE) -f Makefile
sub-tests-make_first-ordered: sub-examples-make_first-ordered  FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/tests/tests.pro ) && $(MAKE) -f Makefile 
sub-tests-make_first: FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/tests/tests.pro ) && $(MAKE) -f Makefile 
sub-tests-all-ordered: sub-examples-all-ordered  FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/tests/tests.pro ) && $(MAKE) -f Makefile all
sub-tests-all: FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/tests/tests.pro ) && $(MAKE) -f Makefile all
sub-tests-clean-ordered: sub-examples-clean-ordered  FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/tests/tests.pro ) && $(MAKE) -f Makefile clean
sub-tests-clean: FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/tests/tests.pro ) && $(MAKE) -f Makefile clean
sub-tests-distclean-ordered: sub-examples-distclean-ordered  FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/tests/tests.pro ) && $(MAKE) -f Makefile distclean
sub-tests-distclean: FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/tests/tests.pro ) && $(MAKE) -f Makefile distclean
sub-tests-install_subtargets-ordered: sub-examples-install_subtargets-ordered  FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/tests/tests.pro ) && $(MAKE) -f Makefile install
sub-tests-install_subtargets: FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/tests/tests.pro ) && $(MAKE) -f Makefile install
sub-tests-uninstall_subtargets-ordered: sub-examples-uninstall_subtargets-ordered  FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/tests/tests.pro ) && $(MAKE) -f Makefile uninstall
sub-tests-uninstall_subtargets: FORCE
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/tests/tests.pro ) && $(MAKE) -f Makefile uninstall

Makefile: ../qssh.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
...
sub-src-check_ordered:
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/src/src.pro ) && $(MAKE) -f Makefile check
sub-examples-check_ordered: sub-src-check_ordered 
	@test -d examples/ || mkdir -p examples/
	cd examples/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/examples/examples.pro ) && $(MAKE) -f Makefile check
sub-tests-check_ordered: sub-examples-check_ordered 
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/tests/tests.pro ) && $(MAKE) -f Makefile check
check: sub-src-check_ordered sub-examples-check_ordered sub-tests-check_ordered

sub-src-benchmark_ordered:
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/src/src.pro ) && $(MAKE) -f Makefile benchmark
sub-examples-benchmark_ordered: sub-src-benchmark_ordered 
	@test -d examples/ || mkdir -p examples/
	cd examples/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/examples/examples.pro ) && $(MAKE) -f Makefile benchmark
sub-tests-benchmark_ordered: sub-examples-benchmark_ordered 
	@test -d tests/ || mkdir -p tests/
	cd tests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/radek/SSH/QSSh2/QSsh/tests/tests.pro ) && $(MAKE) -f Makefile benchmark
benchmark: sub-src-benchmark_ordered sub-examples-benchmark_ordered sub-tests-benchmark_ordered
