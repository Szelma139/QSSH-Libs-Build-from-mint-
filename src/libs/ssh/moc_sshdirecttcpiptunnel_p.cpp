...
#include "../../../../src/libs/ssh/sshdirecttcpiptunnel_p.h"
...
void QSsh::Internal::SshDirectTcpIpTunnelPrivate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SshDirectTcpIpTunnelPrivate::initialized)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject QSsh::Internal::SshDirectTcpIpTunnelPrivate::staticMetaObject = {
    { &SshTcpIpTunnelPrivate::staticMetaObject, qt_meta_stringdata_QSsh__Internal__SshDirectTcpIpTunnelPrivate.data,
      qt_meta_data_QSsh__Internal__SshDirectTcpIpTunnelPrivate,  qt_static_metacall, nullptr, nullptr}
};
