...
#include "../../../../src/libs/ssh/sshdirecttcpiptunnel.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QSsh__SshDirectTcpIpTunnel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QSsh__SshDirectTcpIpTunnel_t qt_meta_stringdata_QSsh__SshDirectTcpIpTunnel = {
    {
QT_MOC_LITERAL(0, 0, 26), // "QSsh::SshDirectTcpIpTunnel"
QT_MOC_LITERAL(1, 27, 11), // "initialized"
...
void QSsh::SshDirectTcpIpTunnel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SshDirectTcpIpTunnel::initialized)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SshDirectTcpIpTunnel::error)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject QSsh::SshDirectTcpIpTunnel::staticMetaObject = {
    { &QIODevice::staticMetaObject, qt_meta_stringdata_QSsh__SshDirectTcpIpTunnel.data,
      qt_meta_data_QSsh__SshDirectTcpIpTunnel,  qt_static_metacall, nullptr, nullptr}
};
...
void *QSsh::SshDirectTcpIpTunnel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QSsh__SshDirectTcpIpTunnel.stringdata0))
