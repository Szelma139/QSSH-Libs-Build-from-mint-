...
#include "../../../../src/libs/ssh/sshremoteprocess.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QSsh__SshRemoteProcess_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QSsh__SshRemoteProcess_t qt_meta_stringdata_QSsh__SshRemoteProcess = {
    {
QT_MOC_LITERAL(0, 0, 22), // "QSsh::SshRemoteProcess"
QT_MOC_LITERAL(1, 23, 7), // "started"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 23), // "readyReadStandardOutput"
QT_MOC_LITERAL(4, 56, 22), // "readyReadStandardError"
QT_MOC_LITERAL(5, 79, 6), // "closed"
QT_MOC_LITERAL(6, 86, 10) // "exitStatus"
...
void QSsh::SshRemoteProcess::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SshRemoteProcess::started)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (SshRemoteProcess::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SshRemoteProcess::readyReadStandardOutput)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (SshRemoteProcess::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SshRemoteProcess::readyReadStandardError)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SshRemoteProcess::closed)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject QSsh::SshRemoteProcess::staticMetaObject = {
    { &QIODevice::staticMetaObject, qt_meta_stringdata_QSsh__SshRemoteProcess.data,
      qt_meta_data_QSsh__SshRemoteProcess,  qt_static_metacall, nullptr, nullptr}
};
...
void *QSsh::SshRemoteProcess::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QSsh__SshRemoteProcess.stringdata0))
