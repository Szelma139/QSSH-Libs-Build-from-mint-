...
#include "../../../../src/libs/ssh/sftpfilesystemmodel.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QSsh__SftpFileSystemModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QSsh__SftpFileSystemModel_t qt_meta_stringdata_QSsh__SftpFileSystemModel = {
    {
QT_MOC_LITERAL(0, 0, 25), // "QSsh::SftpFileSystemModel"
QT_MOC_LITERAL(1, 26, 19), // "sftpOperationFailed"
QT_MOC_LITERAL(2, 46, 0), // ""
QT_MOC_LITERAL(3, 47, 12), // "errorMessage"
QT_MOC_LITERAL(4, 60, 15), // "connectionError"
QT_MOC_LITERAL(5, 76, 21), // "sftpOperationFinished"
QT_MOC_LITERAL(6, 98, 15), // "QSsh::SftpJobId"
...
void QSsh::SftpFileSystemModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SftpFileSystemModel::sftpOperationFailed)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (SftpFileSystemModel::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SftpFileSystemModel::connectionError)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SftpFileSystemModel::sftpOperationFinished)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject QSsh::SftpFileSystemModel::staticMetaObject = {
    { &QAbstractItemModel::staticMetaObject, qt_meta_stringdata_QSsh__SftpFileSystemModel.data,
      qt_meta_data_QSsh__SftpFileSystemModel,  qt_static_metacall, nullptr, nullptr}
};
...
void *QSsh::SftpFileSystemModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QSsh__SftpFileSystemModel.stringdata0))
