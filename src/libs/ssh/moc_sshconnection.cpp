...
#include "../../../../src/libs/ssh/sshconnection.h"
...
void QSsh::SshConnection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SshConnection::dataAvailable)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SshConnection::error)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject QSsh::SshConnection::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QSsh__SshConnection.data,
      qt_meta_data_QSsh__SshConnection,  qt_static_metacall, nullptr, nullptr}
};
...
void *QSsh::SshConnection::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QSsh__SshConnection.stringdata0))
